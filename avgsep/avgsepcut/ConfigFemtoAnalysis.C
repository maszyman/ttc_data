...
AliFemtoManager* ConfigFemtoAnalysis() {
  ...
  AliFemtoAvgSepCorrFctn          *cAvgSepkttpc[50*2];
            ...
            if (runepvzero[iepvzero]) {
              ...
              if (runtype == 0) {
                ...
                if (ichg != 2) {
                  ...
                  sqpcetaphitpc[aniter]->SetMinAvgSeparation(10);
                }
              }
              ...
              if (runktdep) {
                ...
                for (int ikt=0; ikt<numOfkTbins; ikt++) {
                  ...
                  if (ichg == 2) {
                    ...
                    cAvgSepkttpc[ktm] = new AliFemtoAvgSepCorrFctn(Form("cAvgSep%stpcM%iPsi%ikT%i", chrgs[ichg], imult, iepvzero, ikt),4*nbinssh,0.0,200);
                    cAvgSepkttpc[ktm]->SetPairSelectionCut(ktpcuts[ktm]);
                    anetaphitpc[aniter]->AddCorrFctn(cAvgSepkttpc[ktm]);
